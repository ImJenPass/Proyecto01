...
//Es la misma que en ProductoEmpacado solo que la cantidad es float en vez de int xd
/**
 *
 * @author Juan Arballo, Juan Alatorre
 */
//Producto Granel es heredado de la clase Producto
public class ProductoGranel extends Producto {
    ...
    /*Constructor que reciba como parámetros un objeto de tipo Poducto y una Cantidad entera
    ...
    public ProductoGranel(float cantidad, String clave, String nombre, char tipo, String unidad) {
    ...
    cantidad se inicializará con 0.0
     */
