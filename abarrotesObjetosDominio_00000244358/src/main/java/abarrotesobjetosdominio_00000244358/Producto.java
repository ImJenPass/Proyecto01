...
public class Producto {
    ...
    //Constructor que reciba solo la clave del producto e inicialice con ella el atributo de su clase, los demas atributos de la clase se inicializaran a null o ´ ´
